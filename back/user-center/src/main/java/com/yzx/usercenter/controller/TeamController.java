...
import com.yzx.usercenter.common.DeleteRequest;
...
import com.yzx.usercenter.model.request.TeamAddRequest;
...
public class TeamController {
    ...
    public BaseResponse<List<TeamUserVO>> listTeams(TeamQuery teamQuery, HttpServletRequest request){
        ...
        final List<Long> teamIddList = teamList.stream().map(TeamUserVO::getId).collect(Collectors.toList());
        //判断当前用户是否加入队伍
        QueryWrapper<UserTeam> userTeamQueryWrapper = new QueryWrapper<>();
        try {
            User loginUser = userService.getLoginUser(request);
            userTeamQueryWrapper.eq("userId",loginUser.getId());
            userTeamQueryWrapper.in("teamId",teamIddList);
        ...
        userTeamJoinQueryWrapper.in("teamId",teamIddList);
